...
public interface AnswerMapper {
    ...
    List<Answer> getUserFormList(@Param("title")String title,@Param("user_name")String user_name, @Param("begin_num") int begin_num, @Param("page_size") int page_size);
    ...
    int getAnswerCount(int form_id);
