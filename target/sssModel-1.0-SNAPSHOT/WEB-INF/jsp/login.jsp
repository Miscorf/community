                    ...
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            <div  class="form-validate" id="loginFrom">
                                ...
                                <div class="form-group">
                                    <input id="login-password" type="password" name="user_password" required data-msg="请输入密码" placeholder="密码" class="input-material">
                                </div>
        ...
        $(function () {
            ...
            $("#login").click(function () {
                ...
                if (username === '' || password === ''){
                    ...
                    let url = "/user/sub_login";
                    let data = JSON.stringify({"user_id":username,"user_password":password});
                    $.ajax({
                        type:'POST',
                        url:url,
                        data:data,
