    ...
    <div class="layui-header header header-demo">
        <div class="layui-main">
            ...
            <ul class="layui-nav" lay-filter="">
                ...
                <li class="layui-nav-item"><img src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1971739078,3801199234&fm=26&gp=0.jpg" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" alt=""></li>
    ...
    <div class="layui-side layui-bg-black x-side show_list" style="left:0px;" id="table1">
        <div style="height: 130px; width: 220px; ">
            <a class="img" title="我的头像" style="display: block;width: 80px;height: 80px;margin: 10px auto 10px;">
                <img src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1971739078,3801199234&fm=26&gp=0.jpg" class="userAvatar" style="display: block;width: 100%;height: 100%;border-radius: 50%;-webkit-border-radius: 50%;-moz-border-radius: 50%;border: 4px solid #44576b;box-sizing: border-box;">
            </a>
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe60f;</i><cite>缴费管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class=""> <a href="javascript:;" _href="/test/conference-list">
                            <cite>
                                <c:if test="${sessionScope.resident.identity != '居民'}">添加缴费</c:if>
                                <c:if test="${sessionScope.resident.identity == '居民'}">查看缴费</c:if>
                            </cite>
                        </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="/test/view-vote"> <cite>缴费情况</cite> </a> </dd>
                    </dl>
                </li>
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe60f;</i><cite>信息管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class=""> <a href="javascript:;" _href="/test/entr-services"><cite>人员信息管理</cite> </a> </dd>
                    </dl>
                </li>


                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe60f;</i><cite>信息采集管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class=""> <a href="javascript:;" _href="/test/entr-services"><cite>发布信息采集</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="/test/entr-accepted-services"><cite>已采集的信息</cite> </a> </dd>
                    </dl>
                </li>
